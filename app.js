// Create simplified versions of shadcn components
...
// Main component
const MobileFinanceTracker = () => {
  // Copy and paste the component code here, removing the shadcn/ui imports
  // and using the simplified components defined above
  
  // ...rest of your React component code...
};

// Render the app
ReactDOM.render(<MobileFinanceTracker />, document.getElementById('root'));
